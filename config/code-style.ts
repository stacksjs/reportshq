...
const config: PickierOptions = {
  ...
  ignores: [
    ...
    '**/coverage/**',
    '**/temp/**',
    // The compiled chart bundle. Generated by `buddy build --web-components`
    // from resources/components/charts, minified, and committed because the
    // pages serve it. Linting a build artefact reports thousands of findings
    // about code nobody wrote.
    'public/reportshq-charts.js',
    'public/reportshq-charts.css',
