...
const config: PickierOptions = {
  ...
  ignores: [
    ...
    // Generated by the framework from the app's models and functions, and
    // rewritten on every `buddy generate`. pickier 0.1.65 started reading the
    // barrels' unused type imports, which are the generator's to emit or not.
