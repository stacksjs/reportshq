...
export interface paths {
  ...
  "/api/projects/{id}/invites/{inviteId}": {
    ...
    parameters: {
      query?: never
      header?: never
      path: { "id": string; "inviteId": string }
      cookie?: never
    }
    requestBody?: never
    responses: {
